  ...
  return (
    <div className="max-w-3xl mx-auto px-5 py-6">
      ...
      {!alerts.length ? <p className="text-mut">No alerts yet. Open a product and tap “Notify me”.</p> : (
        <div className="rounded-2xl border border-[#F1E7DC] bg-white overflow-hidden">
          {alerts.map((a, i) => (
            <div key={i} className="flex items-center justify-between p-3 border-b border-[#F1E7DC] last:border-0">
